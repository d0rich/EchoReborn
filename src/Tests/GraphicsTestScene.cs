...
/// </summary>
public class GraphicsTestScene
{
    private GraphicsDevice _graphicsDevice;
    private SpriteBatch _spriteBatch;
    private SpriteFont _font;
    
    public GraphicsTestScene(GraphicsDevice graphicsDevice, SpriteBatch spriteBatch, SpriteFont font = null)
    {
    ...
    public void Draw()
    {
        ...
        if (_font != null)
        {
            _spriteBatch.DrawString(_font, "Graphics Test Scene", new Vector2(300, 200), Color.White);
